...
This development kit provides scripts to evaluate tracking/detection results.
...
2)
The folder containing the tracking/detection results. Each one should be saved in a
